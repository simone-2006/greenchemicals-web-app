...
export default function SettingsPage() {
    ...
    return (
        <div>
            ...
            <div className="flex gap-2 w-full h-[calc(100dvh-8rem)]">
                <div className="mt-4 flex w-full sm:w-auto h-full">
                    <div
                        className="flex flex-col w-full gap-1 rounded-md border border-border p-1 sm:w-auto"
                        role="tablist"
                ...
                <div className="mt-4 rounded-md border border-border bg-background-element p-4 flex-1">
                    {activeTab === "account" && (
                        <div>
                    ...
                    {activeTab === "general" && (
                        <div>
                            ...
                            <input
                                type="color"
                                className="w-50 h-10 p-0 border-0 cursor-pointer rounded-md"
                                value={primaryColor}
